...
URI
/api/v1/{division}/sync/Deleted


GET
Example usage
/api/v1/{division}/sync/Deleted?$filter=Timestamp gt 5&$select=DeletedBy


Properties
Name ↑↓	Type ↑↓	Description ↑↓
	Timestamp 	Edm.Int64	Timestamp
	DeletedBy	Edm.Guid	UserID of person who deleted record
	DeletedDate	Edm.DateTime	Deleted date
	Division	Edm.Int32	Division code
	EntityKey	Edm.Guid	Entity key
	EntityType	Edm.Int32	Entity Types:
1= TransactionLines
2= Accounts
3= Addresses
4= Attachments
...
9= Items
10= PaymentTerms
12= SalesOrders (This entity is going to be removed. Please refer to the new entity SalesOrderHeaders, SalesOrderLines.)
13= SalesInvoices
