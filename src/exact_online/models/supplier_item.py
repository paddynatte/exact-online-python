...
class SupplierItem(ExactBaseModel):
    """
    A link between a supplier and an item with purchase price information.
    ...
    country_of_origin_description: str | None = Field(default=None, alias="CountryOfOriginDescription")
    ...
    purchase_unit_description: str | None = Field(default=None, alias="PurchaseUnitDescription")
    ...
    purchase_vat_code_description: str | None = Field(default=None, alias="PurchaseVATCodeDescription")
    ...
    def __repr__(self) -> str:
        ...
        return f"SupplierItem(item_code={self.item_code!r}, supplier_code={self.supplier_code!r})"
